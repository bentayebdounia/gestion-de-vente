...
class ModifierProduit extends Component {
    ...
    changeDateProductionHandler= (event) =>{
        this.setState({dateProduction: event.target.value});
    }
                   ...
                   <div className="containee">
                       <div className='row'>  
                            <div className='card col-md-6 offset-md-3'>  
                                <h3 className='text-center'> Modifier Produit</h3>
                                <div className='card-body'>
                                    ...
                                    <form>
                                        <div className='form-group'>
                                            ...
                                            <input  name='intitule' className='form-control'
                                        ...
                                        <div className='form-group'> 
                                            ...
                                            <select class="form-select" aria-label="Default select example" value={this.state.categorie} onChange={this.changeCategorieHandler} >
                                                <option selected>{this.state.categorie}</option>
                                        ...
                                        <div className='form-group'>  
                                            ...
                                            value={this.state.dateProduction} onChange={this.changeDateProductionHandler} />
                                        </div> 

                                        <div className='form-group'>   
                                            <label> Prix </label>
                                            <input name='prix' className='form-control' 
